...
const style = {
  ...
  //
  HeaderLeftSideMobile: styled(Grid)(({ theme }) => ({
    borderRadius: "5px",
    padding: "10px",
  ...
  DropNameMobile: styled("div")(({ theme }) => ({
    fontFamily: theme.fontFamily.primary,
    fontWeight: 900,
    fontSize: "1em",
    marginRight: "5px",
  ...
  InfoContainerRight: styled("div")(({ theme }) => ({
  ...
  ContainerTitle2: styled("div")(({ theme }) => ({
    fontFamily: theme.fontFamily.primary,
    backgroundColor: theme.colors.black,
    color: "white",
    padding: "5px",
  ...
  MintSelectNFT: styled("div")(({ theme }) => ({
    fontFamily: theme.fontFamily.primary,
    textAlign: "center",
    fontWeight: 500,
    fontSize: "0.9em",
